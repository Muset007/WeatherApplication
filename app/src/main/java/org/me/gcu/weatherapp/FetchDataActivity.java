...
public class FetchDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherIcon = findViewById(R.id.weatherIcon); // Initialize weatherIcon

        // Set click listener for cityFinder
        cityFinder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FetchDataActivity.this, cityFinder.class);
...
//            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION},REQUEST_CODE);
    ...
    private void letsdoSomeNetworking(RequestParams params){
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Toast.makeText(FetchDataActivity.this, "Data Get Success", Toast.LENGTH_SHORT).show();
    ...
    private void updateUI(weatherData weather){
        try {
            ...
            e.printStackTrace();
            // Handle any exceptions, e.g., log error or display a toast message
        }
    }
    @Override
